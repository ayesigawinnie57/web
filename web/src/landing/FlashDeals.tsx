  ...
  return (
    ...
    >
      <div className="relative aspect-square overflow-hidden bg-[#F8FAFC]">
        {product.image
          ? <img src={product.image} alt={product.name} loading="lazy" className="h-full w-full object-cover transition duration-200 group-hover:scale-105" />
      ...
      <div className="flex flex-1 flex-col gap-2 p-2.5">
        <p className="truncate text-[11px] font-bold leading-[1.35] text-[#071A2B]">{product.name}</p>
